...
INSERT INTO "component" VALUES('conch', '', '');
INSERT INTO "component" VALUES('ftp', '', '');
CREATE TABLE milestone (name text not null, due integer, completed integer, description text, primary key (name));
INSERT INTO "milestone" VALUES('not done, not due', null, null, 'description');
INSERT INTO "milestone" VALUES('done, not due', null, 1, 'description');
INSERT INTO "milestone" VALUES('not done, due', 1334367409, 0, 'description');
INSERT INTO "milestone" VALUES('done, due', 1334367409, 1, 'description');
CREATE TABLE enum (type text not null, name text not null, value text, primary key (type, name));
INSERT INTO "enum" VALUES('priority', 'drop everything', '');
INSERT INTO "enum" VALUES('priority', 'normal', '');
INSERT INTO "enum" VALUES('severity', 'missing limb', '');
INSERT INTO "enum" VALUES('ticket_type', 'enhancement', '');
INSERT INTO "enum" VALUES('resolution', 'fixed', '');
INSERT INTO "enum" VALUES('resolution', 'invalid', '');
INSERT INTO "enum" VALUES('resolution', 'wontfix', '');
INSERT INTO "enum" VALUES('resolution', 'duplicate', '');
INSERT INTO "enum" VALUES('resolution', 'worksforme', '');
COMMIT;
